...
This file deliberately favors a short public statement over a tight bound.  The tower
below uses real powers, so even very large heights remain symbolic: Lean never expands an
astronomical natural numeral.
-/
