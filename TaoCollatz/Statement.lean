...
The witnessed `c, C` are explicit (`c ≈ 2.25e-9`, `C ≈ 5.6e30`); their closed forms and
tuning knobs are in `notes/effective-constants.md` (calculator: `tools/tao_effective_constants.py`). -/
