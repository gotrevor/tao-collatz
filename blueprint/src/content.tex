...
\lapsrisk{13--28 (sweep 5--10 + real separation 4--8 + kernel 4--10)}{medium-high --- route restored to paper-faithful; risk is now grind + the mapped \(\varepsilon\)-sweep}{70\% (2026-07-12 altitude ruling: Remedy A, \(\varepsilon = 10^{-90}\))}
\end{lemma}
