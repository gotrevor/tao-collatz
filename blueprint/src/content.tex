...
%    * Statement-`\leanok` is set on the 18 nodes whose `\lean{}`-bound statements are
%      landed, compiled, and judge-ratified (S1 S2 S4 C1--C7 C9 C10 X2 X3 X4 X6 X7 X11).
%      The 7 nodes with no canonical Lean name yet (S3 C8 X1 X5 X8 X9 X10) keep `\notready` until
