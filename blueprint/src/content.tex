...
(Prop~1.17) is derived across the (1.26) seam.  Open: the \texttt{cexpect\_pairing}
induction itself (the lone X1 sorry).
\lapsrisk{4--8}{medium --- statement pinned, factorization algebra proved}{80\% (2026-07-12 judge pass 10: (7.5) ratified vs pp.33--35)}
\end{definition}
