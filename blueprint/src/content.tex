...
Proof machinery landed (laps 46--48, judge pass 6): the renewal decomposition
\texttt{fpDist\_le\_renewal\_conv} (budget induction; monotone height kills the barrier
condition) and the Gaussian AP-sum toolkit are PROVED axiom-clean; the lemma is reduced
to \texttt{renewalMass\_bound} (sum of Lemma 2.2(i) in \(k\), three regions) plus the
last-step assembly, both pinned with route and constants recorded.
\lapsrisk{4--10}{medium}{80\% (2026-07-12 judge re-rate: reduction proved; kernel numerics validated at 200k trials)}
\end{lemma}
