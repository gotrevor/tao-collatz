...
at \((0, 1-p_0)\) = the fixed point) --- all axiom-checked.  Open: the two-level \(Y/Z\)
induction assembly + the \texttt{fpDist\_white\_exit\_deep} input itself.
\lapsrisk{3--6}{medium --- gated statement re-ratified; Z-induction assembly + deep-exit input open}{75\% (2026-07-12 judge pass 14: 13 gated fold/chain lemmas re-verified axiom-clean)}
\end{lemma}
