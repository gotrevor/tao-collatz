...
\lapsrisk{4--10}{medium --- risk kernel 1, engine verified}{85\% (2026-07-12 judge re-rate 2, after laps 33--40: the analytic engine is COMPLETE and judge-verified axiom-clean --- the tilted center bound and the full 2-D second-order MGF bound with exact mean $(4,16)$ both check at [propext, Classical.choice, Quot.sound]; what remains is the F5 $\lambda$-clip assembly of the Hold instance plus the five 1-D instance discharges)}
\end{lemma}
