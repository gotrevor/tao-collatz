...
\begin{lemma}[Large triangles rarely encountered; Lemma 7.10]\label{X10}
  \lean{triangle_encounter_le, fpDistPlus, bigTriangleSet, TriangleFamily.not_mem_two, fpDistPlus_height_tail, fpDistPlus_col_tail}
  \uses{X3, X6, S3}
  \leanok
...
\lapsrisk{10--20}{high --- risk kernel 3b, statements pinned}{70\% (2026-07-12 judge pass 18: re-pin + (7.61) tails ratified; separated-\(\Sigma\) summation still open)}
\end{lemma}
